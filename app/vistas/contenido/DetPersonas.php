<?php ob_start() ;?>
        ...
        <h3>Personas</h3>  
        <?php if($esAdmin==TRUE): ?>
            <a href="index.php?ctl=Nuevo&form=personas&clave=1">Agregar Persona</a>
        <?php endif ?>
        <?php if($params['personas']!=FALSE):foreach($params['personas'] as $persona):?>
                ...
                <article  class="detalles">
                    ...
                    <table id="table-personas" class="table table-bordered table-hover">
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if(!empty($persona['primer_apellido'])):echo $persona['primer_apellido']; endif;?>
                            </td>
                            <th>Segundo apellido</th>
                            <td>
                                <?php if(!empty($persona['segundo_apellido'])):echo $persona['segundo_apellido'];endif;?>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <th>Nombres</th>
                            <td>
                                <?php if(!empty($persona['nombres'])): echo $persona['nombres']; endif;?>
                            </td>
                            <th>Género</th>
                            <td>
                                <?php   if(!empty($persona['genero'])):  echo $persona['genero']; endif; ?>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td colspan="4"><?php   if(!empty($persona['responsabilidades'])):
                    ...
                    <table id="table-personas" class="table table-bordered table-hover">
                        ...
                        <tr>
                            <td colspan="4"> <?php   if(!empty($persona['titulos_certificaciones'])):
                        ...
                        <tr>
                            <td colspan="4"> <?php   if(!empty($persona['experiencia_empresarial'])):
                        ...
                        <tr>
                            <td colspan="4"> <?php   if(!empty($persona['experiencia_docente'])):
                        ...
                        <tr>
                           <td colspan="4">   <?php   if(!empty($persona['referencias'])):
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <tr>
                            ...
                            <td><?php   if(!empty($persona['direccion_oficina'])):
                        ...
                        <tr>
                            <th>Teléfono</th>
                            <td><?php   if(!empty($persona['telefono'])):
                        ...
                        <tr>
                            <th>Dependencia</th>
                            <td> <?php   if(!empty($persona['dependencia'])):
                        ...
                        <tr>
                            ...
                            <td> <?php   if(!empty($persona['ciudad_labora'])):
